...
Changelogs = [
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Added new alert type (info)!"},
        ],
    },
    {
        "Build": 1585326252,
        ...
        "Changes": [
            {"Type": 4, "Content": "Added new change type (FIX)."},
            {
                "Type": 5,
                "Content": "Fixed all card headers appearing at the same time.",
            },
            {"Type": 4, "Content": "Added margins around changelog types."},
        ],
    },
    {
        "Build": 1585505344,
        ...
        "Changes": [
            {"Type": 2, "Content": "Ordered recent plays by time rather than id."},
            {
                "Type": 6,
                "Image": "/static/img/changelog/useredit-htmlbadges.png",
                "Content": "Replaced 'buttons' with badges in users list.",
            },
            {"Type": 4, "Content": "Added new changelog type (REPLACE)."},
            {"Type": 2, "Content": "Ranking logs now state whether"},
            {"Type": 5, "Content": "Replaced GitHub icon in sidebar."},
            {
                "Type": 6,
                "Content": "Replaced input fields with textareas for multi-line input in user edit.",
            },
            {"Type": 5, "Content": "Fixed new lines being broken in user edit."},
            {"Type": 4, "Content": "Added image support for changelogs"},
        ],
    },
    {
        "Build": 1585511551,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Added release type text to changelogs."},
            {
                "Type": 4,
            ...
            {"Type": 6, "Content": "Set the default panel theme to the dark theme."},
            {
                "Type": 3,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Made user search display the current query."},
            {"Type": 4, "Content": "Added loading bars to show page loading progress."},
            {"Type": 4, "Content": "Differentiated error log exceptions."},
            {
                "Type": 4,
    ...
    },
    {
        ...
        "Changes": [
            {"Type": 4, "Content": "Added password changing to user edition."},
            {"Type": 4, "Content": "Added supporter giving with set end time."},
            {
                "Type": 2,
    ...
    },
    {
        ...
        "Changes": [
            {"Type": 5, "Content": "Fixed incorrect column names in delete user."},
            {"Type": 5, "Content": "Fixed incorrect redirect after deleting user."},
            {"Type": 5, "Content": "Fixed rpusers.json not creating on first start."},
            {
                "Type": 2,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Added logging to password changes via the panel."},
            {
                "Type": 5,
                "Content": "Fixed user edition with lacking privileges not returning a valid result.",
            },
            {"Type": 5, "Content": "Fixed incorrect column names in user wipe."},
            {
                "Type": 5,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Added pagination to admin logs."},
            {
                "Type": 5,
                "Content": "Fixed remove from leaderboards not working on autopilot leaderboards.",
            },
            {"Type": 5, "Content": "Fixed user wipe causing an SQL syntax error."},
            {"Type": 2, "Content": "Disallowed the logging into the bot account."},
        ],
    },
    {
        "Build": 1589636106,
        ...
        "Changes": [
            ...
            {"Type": 2, "Content": "Adjusted list splitting."},
            {"Type": 2, "Content": "Optimised backend SQL cursor fetches."},
            {
                "Type": 5,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Added accuracy to recent plays."},
            {
                "Type": 4,
            ...
            {"Type": 2, "Content": "Removed duplicate queries from user deletion."},
        ],
    },
    {
        "Build": 1590437250,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 2, "Content": "Using username_safe for logins again."},
            {
                "Type": 2,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Wipes now will also clear the user's playcount."},
            {
                "Type": 4,
                "Content": "Added optional webhooks for admin logs and RealistikPanel console logs.",
            },
            {"Type": 5, "Content": "Fixed pagination on clans."},
            {
                "Type": 5,
                "Content": "Fixed registered users being called online users on the stats page.",
            },
            {"Type": 5, "Content": "Fixed the redirects on gamemode wipes."},
        ],
    },
    {
        "Build": 1593530430,
        ...
        "Changes": [
            ...
            {"Type": 5, "Content": "Fix song playback on beatmap rank page."},
        ],
    },
    {
        "Build": 1597593141,
        ...
        "Changes": [
            {"Type": 4, "Content": "Add separate privilege for viewing user IPs."},
            {"Type": 4, "Content": "Add logging for freezing users"},
            {"Type": 4, "Content": "Added support for Ainu-style freeze timestams."},
            {
                "Type": 6,
                "Content": "Restricting and freezing now sends a FokaBot message rather than disconnecting the user.",
            },
            {"Type": 2, "Content": "Solved rpusers.json not being created correctly."},
            {"Type": 2, "Content": "Solve issues with SSL status API."},
        ],
    },
    {
        "Build": 1615490957,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 4, "Content": "Add modern flags showcasing user nationalities."},
            {
                "Type": 5,
    ...
    },
    {
        ...
        "Changes": [
            ...
            {"Type": 2, "Content": "Properly supporting USSR leaderboard refreshes."},
            {"Type": 2, "Content": "More interconnected Redis backend."},
        ],
    },
    {
        "Build": 1657558726,
        ...
        "Changes": [{"Type": 4, "Content": "Added ban logs to the panel."}],
    },
]
